        ...
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              placeholder="https://fb.com/chiang_galon"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://twitter.com/chiang_galon"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://instagram.com/chiang_galon"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://github.com/chiang_galon"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://t.me/chiang_galon"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://linkedin.com/chiang_galon"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="chiang_galon@geemail.com"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://youtube.com/chiang_galon"
            />
          </div>
        </div>
        <div>
